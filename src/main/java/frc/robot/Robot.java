...
public class Robot extends TimedRobot implements Executable, LogHelper {
    ...
    public void init() {
        ...
        // Create the brains of the robot. This runs the routines.
        controller = new Controller(subsystems);
        warning("Controlled created");

        // Setup the interface to the user, mapping buttons to routines for the
        // controller.
        setupUserInterface();
        warning("OI created");
        ...
        // Setup the auto routine chooser.
        auto = new Auto();
        warning("Auto routine chooser started");
    ...
    private void createPowerMonitor() {
        ...
        boolean enabled = Config.pdp.enabled || Config.pdp.monitor;
        if (enabled) {
    ...
    private void setupUserInterface() {
        ...
        oi.registerDriveModes(driverLeftJoystick, driverRightJoystick, dancepad);
