 ...
 */
public abstract class AutoDriveBase extends Mode {
    ...
    public AutoDriveBase(String name, DriveTelemetry telemetry, Clock clock) {
         ...
         */
        // TODO: Disabled whilst testing Balance code
        LowPassFilter filteredSpeed = new LowPassFilter(this::getTargetSpeed, 1);
    ...
    private PositionPID createPID(String name, DoubleSupplier targetSpeed,
        ...
        pid.setVAPID(0.3, 0,
                Config.drivebase.autoPidf.p, Config.drivebase.autoPidf.i,
                Config.drivebase.autoPidf.d);
        return pid;
    }
