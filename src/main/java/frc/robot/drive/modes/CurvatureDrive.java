 ...
 */
public class CurvatureDrive extends Mode {
    ...
    public CurvatureDrive(ContinuousRange throttle, ControlMode controlMode, ContinuousRange wheel,
            Switch isQuickTurn) {
        super("Curvature", controlMode);
