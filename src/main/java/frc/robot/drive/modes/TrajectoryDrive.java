 ...
 */
public class TrajectoryDrive extends Mode {
    ...
    public TrajectoryDrive(Location location, Clock clock) {
        ...
        Chart.register(() -> m_leftSpeedSetpoint, "TrajectoryDrive/trajectory/speed/leftSetpoint");
        Chart.register(() -> m_rightSpeedSetpoint,
                "TrajectoryDrive/trajectory/speed/rightSetpoint");
     ...
     * @param parameters
     */
    synchronized public void reset(Parameters parameters) {
        m_targetSpeed = 0;
        m_prevTime = 0;
