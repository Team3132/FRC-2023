...
public interface Motor extends SpeedSensor, Stoppable, Requirable {
     ...
     * @param mode percent output, position, velocity etc.
     * @param demand for percent [-1,1].
     * @param arbFeedFwd add this amount on to output. Only supported by TalonSRX. Range [-1, 1].
     */
    public void set(final ControlMode mode, double demand, double arbFeedFwd);
     ...
     * @param ticksPerTurn How many encoder ticks per turn, eg 4096 or 42.
     * @param gearRatio How many turns of the motor to turn the output shaft, eg 11
     * @param unitsPerRevolution e.g. How many units does the wheel move for every turn.
     * @return this.
     */
    public default Motor setScale(double ticksPerTurn, double gearRatio,
    ...
    /**
     * Override the position of the quadrature encoder, resetting to 0
     */
    public default Motor resetEncoder() {
     ...
     */
    public default Motor resetEncoder(double position) {
        // Not implemented by default.
        return this;
    }
