...
public class HardwareTalonSRX implements Motor {
    ...
    private LimitSwitchNormal fwdLimitNormal = LimitSwitchNormal.NormallyClosed;
    private LimitSwitchNormal revLimitNormal = LimitSwitchNormal.NormallyClosed;
    ...
    public boolean isAtForwardLimit() {
        if (fwdLimitNormal == LimitSwitchNormal.NormallyClosed) {
    ...
    public boolean isAtReverseLimit() {
        if (revLimitNormal == LimitSwitchNormal.NormallyClosed) {
    ...
    public ErrorCode configForwardLimitSwitchSource(LimitSwitchSource type,
            ...
            int timeoutMs) {
        this.fwdLimitNormal = normalOpenOrClose;
    ...
    public ErrorCode configReverseLimitSwitchSource(LimitSwitchSource type,
            LimitSwitchNormal normalOpenOrClose,
            int timeoutMs) {
        this.revLimitNormal = normalOpenOrClose;
